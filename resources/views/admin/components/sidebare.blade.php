<style>
  ...
  <aside style="background-color: rgb(24, 37, 53);color:white" id="layout-menu" class="layout-menu menu-vertical menu" data-bg-class="bg-menu-theme" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
          ...
          <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <g id="Pages" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              <g id="Login---V2" transform="translate(-667.000000, -290.000000)">
                ...
                <span class="app-brand-text text-white demo menu-text fw-bold ms-2">Frest</span>
              </a>
            ...
            <ul class="menu-inner py-1 ps">
              ...
              <li class="menu-item" style="">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                    <i class="menu-icon tf-icons fa-sharp fa-solid fa-briefcase"></i>
                  <div>Projects</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item">
             ...
             <li class="menu-item active" style="">
               <a href="" target="_blink" class="menu-link ">
            ...
            <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 878px; right: 4px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></ul>
